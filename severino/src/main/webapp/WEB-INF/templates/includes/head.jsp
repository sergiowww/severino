...
<script type="text/javascript" src="resources/jquery.spring-friendly.min.js"></script>
<script type="text/javascript" src="resources/bootbox.min.js"></script>
<script type="text/javascript" src="resources/jquery.mask.min.js"></script>
<script type="text/javascript" src="js/jquery.dataTable.config.js"></script>
