		...
		<div class="panel-body">
			<form:form cssClass="form-horizontal" modelAttribute="visita" autocomplete="off" servletRelativeAction="/visita">
				...
				<fieldset style="margin-bottom: 10px; margin-top: 5px;">
					...
					<div class="row">
						<tags:selectField label="UF de Emissão" name="visitante.uf" collection="${ufs}" itemLabel="name" itemValue="name" searchItems="false" extraCssClass="col-xs-3" requiredField="true" />
						<tags:inputField label="Órgão Emissor" name="visitante.orgaoEmissor" type="text" extraCssClass="col-xs-3" requiredField="true" />
						<tags:inputField label="Profissão / Cargo" name="visitante.profissao" type="text" requiredField="false" extraCssClass="col-xs-6" readonlyField="false" />
					</div>
				</fieldset>
